...
int process_single_frame(int frame_no) {
...
int extract_current_frame(int frame_no) {

	//VideoCapture cap("E:/University/10sem/Системы технич зрения/studying-computer-vision/Retinex/video/retinex-sample3.mp4");
	VideoCapture cap("C:/retinex-sample3.mp4");
...
{
	//process_video();
	process_single_frame(2009);
	//extract_current_frame(2009);
	return 0;
}
